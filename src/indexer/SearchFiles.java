 ...
 * @throws Exception */
  public static String[] paths(String queryString) throws Exception  {
 /*   String usage =
 ...
 /*  BufferedReader in = null;
    ...
    String line = queryString;
     ...
     if (line == null || line.length() == -1) {
      ...
      String[] paths = doPagingSearch(searcher, query, hitsPerPage, raw, queries == null && queryString == null);
return paths;
 ...
 * @return 
   * 
   */
  public static String[] doPagingSearch(IndexSearcher searcher, Query query, 
